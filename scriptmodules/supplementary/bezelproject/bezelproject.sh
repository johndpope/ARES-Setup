...
function install_bezel_pack() {
    ...
    if [[ "${atheme}" == "mame" ]];then
      ...
      mv "/opt/ares/configs/all/retroarch/config/disable_MAME 2003" "/opt/ares/configs/all/retroarch/config/MAME 2003" 2> /dev/null
...
arcade)
  ...
  mv "/opt/ares/configs/all/retroarch/config/MAME 2003" "/opt/ares/configs/all/retroarch/config/disable_MAME 2003"
...
arcade)
  ...
  then
    ...
    mv "/opt/ares/configs/all/retroarch/config/disable_MAME 2003" "/opt/ares/configs/all/retroarch/config/MAME 2003"
...
n64)
  ...
  if [[ ${ifexist} > 0 ]]
  then
    cp /opt/ares/configs/n6n64/retroarch.cfg /opt/ares/configs/n64/retroarch.cfg.bkp
    cat /opt/ares/configs/n6/retroarch.cfg |grep -v input_overlay |grep -v aspect_ratio |grep -v custom_viewport > /tmp/retroarch.cfg
...
atarilynx_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '5i custom_viewport_width = "1010"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '6i custom_viewport_height = "640"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '7i custom_viewport_x = "455"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '8i custom_viewport_y = "225"' /opt/ares/configs/atarilynx/retroarch.cfg
  else
    cp /opt/ares/configs/atarilynx/retroarch.cfg /opt/ares/configs/atarilynx/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Atari-Lynx-Horizontal.cfg"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/atarilynx/retroarch.cfg
...
atarilynx_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '5i custom_viewport_width = "670"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '6i custom_viewport_height = "425"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '7i custom_viewport_x = "305"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '8i custom_viewport_y = "150"' /opt/ares/configs/atarilynx/retroarch.cfg
  else
    cp /opt/ares/configs/atarilynx/retroarch.cfg /opt/ares/configs/atarilynx/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Atari-Lynx-Horizontal.cfg"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/atarilynx/retroarch.cfg
...
atarilynx_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '5i custom_viewport_width = "715"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '6i custom_viewport_height = "460"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '7i custom_viewport_x = "325"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '8i custom_viewport_y = "160"' /opt/ares/configs/atarilynx/retroarch.cfg
  else
    cp /opt/ares/configs/atarilynx/retroarch.cfg /opt/ares/configs/atarilynx/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Atari-Lynx-Horizontal.cfg"' /opt/ares/configs/atarilynx/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/atarilynx/retroarch.cfg
...
gamegear_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '5i custom_viewport_width = "1160"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '6i custom_viewport_height = "850"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '7i custom_viewport_x = "380"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '8i custom_viewport_y = "120"' /opt/ares/configs/gamegear/retroarch.cfg
  else
    cp /opt/ares/configs/gamegear/retroarch.cfg /opt/ares/configs/gamegear/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sega-Game-Gear.cfg"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gamegear/retroarch.cfg
...
gamegear_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '5i custom_viewport_width = "780"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '6i custom_viewport_height = "580"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '7i custom_viewport_x = "245"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '8i custom_viewport_y = "70"' /opt/ares/configs/gamegear/retroarch.cfg
  else
    cp /opt/ares/configs/gamegear/retroarch.cfg /opt/ares/configs/gamegear/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sega-Game-Gear.cfg"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gamegear/retroarch.cfg
...
gamegear_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '5i custom_viewport_width = "835"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '6i custom_viewport_height = "625"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '7i custom_viewport_x = "270"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '8i custom_viewport_y = "75"' /opt/ares/configs/gamegear/retroarch.cfg
  else
    cp /opt/ares/configs/gamegear/retroarch.cfg /opt/ares/configs/gamegear/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sega-Game-Gear.cfg"' /opt/ares/configs/gamegear/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gamegear/retroarch.cfg
...
gb_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '5i custom_viewport_width = "625"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '6i custom_viewport_height = "565"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '7i custom_viewport_x = "645"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '8i custom_viewport_y = "235"' /opt/ares/configs/gb/retroarch.cfg
  else
    cp /opt/ares/configs/gb/retroarch.cfg /opt/ares/configs/gb/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy.cfg"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gb/retroarch.cfg
...
gb_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '5i custom_viewport_width = "429"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '6i custom_viewport_height = "380"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '7i custom_viewport_x = "420"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '8i custom_viewport_y = "155"' /opt/ares/configs/gb/retroarch.cfg
  else
    cp /opt/ares/configs/gb/retroarch.cfg /opt/ares/configs/gb/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy.cfg"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gb/retroarch.cfg
...
gb_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '5i custom_viewport_width = "455"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '6i custom_viewport_height = "415"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '7i custom_viewport_x = "455"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '8i custom_viewport_y = "162"' /opt/ares/configs/gb/retroarch.cfg
  else
    cp /opt/ares/configs/gb/retroarch.cfg /opt/ares/configs/gb/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy.cfg"' /opt/ares/configs/gb/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gb/retroarch.cfg
...
gba_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '5i custom_viewport_width = "1005"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '6i custom_viewport_height = "645"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '7i custom_viewport_x = "455"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '8i custom_viewport_y = "215"' /opt/ares/configs/gba/retroarch.cfg
  else
    cp /opt/ares/configs/gba/retroarch.cfg /opt/ares/configs/gba/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy-Advance.cfg"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gba/retroarch.cfg
...
gba_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '5i custom_viewport_width = "467"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '6i custom_viewport_height = "316"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '7i custom_viewport_x = "405"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '8i custom_viewport_y = "190"' /opt/ares/configs/gba/retroarch.cfg
  else
    cp /opt/ares/configs/gba/retroarch.cfg /opt/ares/configs/gba/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy-Advance.cfg"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gba/retroarch.cfg
...
gba_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '5i custom_viewport_width = "720"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '6i custom_viewport_height = "455"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '7i custom_viewport_x = "320"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '8i custom_viewport_y = "155"' /opt/ares/configs/gba/retroarch.cfg
  else
    cp /opt/ares/configs/gba/retroarch.cfg /opt/ares/configs/gba/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy-Advance.cfg"' /opt/ares/configs/gba/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gba/retroarch.cfg
...
gbc_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '5i custom_viewport_width = "625"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '6i custom_viewport_height = "565"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '7i custom_viewport_x = "645"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '8i custom_viewport_y = "235"' /opt/ares/configs/gbc/retroarch.cfg
  else
    cp /opt/ares/configs/gbc/retroarch.cfg /opt/ares/configs/gbc/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy-Color.cfg"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gbc/retroarch.cfg
...
gbc_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '5i custom_viewport_width = "430"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '6i custom_viewport_height = "380"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '7i custom_viewport_x = "425"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '8i custom_viewport_y = "155"' /opt/ares/configs/gbc/retroarch.cfg
  else
    cp /opt/ares/configs/gbc/retroarch.cfg /opt/ares/configs/gbc/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy-Color.cfg"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gbc/retroarch.cfg
...
gbc_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '5i custom_viewport_width = "455"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '6i custom_viewport_height = "405"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '7i custom_viewport_x = "455"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '8i custom_viewport_y = "165"' /opt/ares/configs/gbc/retroarch.cfg
  else
    cp /opt/ares/configs/gbc/retroarch.cfg /opt/ares/configs/gbc/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Game-Boy-Color.cfg"' /opt/ares/configs/gbc/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/gbc/retroarch.cfg
...
ngp_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '5i custom_viewport_width = "700"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '6i custom_viewport_height = "635"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '7i custom_viewport_x = "610"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '8i custom_viewport_y = "220"' /opt/ares/configs/ngp/retroarch.cfg
  else
    cp /opt/ares/configs/ngp/retroarch.cfg /opt/ares/configs/ngp/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/SNK-Neo-Geo-Pocket.cfg"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngp/retroarch.cfg
...
ngp_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '5i custom_viewport_width = "461"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '6i custom_viewport_height = "428"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '7i custom_viewport_x = "407"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '8i custom_viewport_y = "145"' /opt/ares/configs/ngp/retroarch.cfg
  else
    cp /opt/ares/configs/ngp/retroarch.cfg /opt/ares/configs/ngp/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/SNK-Neo-Geo-Pocket.cfg"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngp/retroarch.cfg
...
ngp_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '5i custom_viewport_width = "490"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '6i custom_viewport_height = "455"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '7i custom_viewport_x = "435"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '8i custom_viewport_y = "155"' /opt/ares/configs/ngp/retroarch.cfg
  else
    cp /opt/ares/configs/ngp/retroarch.cfg /opt/ares/configs/ngp/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/SNK-Neo-Geo-Pocket.cfg"' /opt/ares/configs/ngp/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngp/retroarch.cfg
...
ngpc_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '5i custom_viewport_width = "700"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '6i custom_viewport_height = "640"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '7i custom_viewport_x = "610"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '8i custom_viewport_y = "215"' /opt/ares/configs/ngpc/retroarch.cfg
  else
    cp /opt/ares/configs/ngpc/retroarch.cfg /opt/ares/configs/ngpc/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/SNK-Neo-Geo-Pocket-Color.cfg"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngpc/retroarch.cfg
...
ngpc_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '5i custom_viewport_width = "460"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '6i custom_viewport_height = "428"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '7i custom_viewport_x = "407"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '8i custom_viewport_y = "145"' /opt/ares/configs/ngpc/retroarch.cfg
  else
    cp /opt/ares/configs/ngpc/retroarch.cfg /opt/ares/configs/ngpc/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/SNK-Neo-Geo-Pocket-Color.cfg"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngpc/retroarch.cfg
...
ngpc_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '5i custom_viewport_width = "490"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '6i custom_viewport_height = "455"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '7i custom_viewport_x = "435"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '8i custom_viewport_y = "155"' /opt/ares/configs/ngpc/retroarch.cfg
  else
    cp /opt/ares/configs/ngpc/retroarch.cfg /opt/ares/configs/ngpc/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/SNK-Neo-Geo-Pocket-Color.cfg"' /opt/ares/configs/ngpc/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/ngpc/retroarch.cfg
...
psp_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '5i custom_viewport_width = "1430"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '6i custom_viewport_height = "820"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '7i custom_viewport_x = "250"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '8i custom_viewport_y = "135"' /opt/ares/configs/psp/retroarch.cfg
  else
    cp /opt/ares/configs/psp/retroarch.cfg /opt/ares/configs/psp/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sony-PSP.cfg"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/psp/retroarch.cfg
...
psp_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '5i custom_viewport_width = "950"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '6i custom_viewport_height = "540"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '7i custom_viewport_x = "165"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '8i custom_viewport_y = "90"' /opt/ares/configs/psp/retroarch.cfg
  else
    cp /opt/ares/configs/psp/retroarch.cfg /opt/ares/configs/psp/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sony-PSP.cfg"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/psp/retroarch.cfg
...
psp_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '5i custom_viewport_width = "1015"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '6i custom_viewport_height = "575"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '7i custom_viewport_x = "175"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '8i custom_viewport_y = "95"' /opt/ares/configs/psp/retroarch.cfg
  else
    cp /opt/ares/configs/psp/retroarch.cfg /opt/ares/configs/psp/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sony-PSP.cfg"' /opt/ares/configs/psp/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/psp/retroarch.cfg
...
pspminis_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '5i custom_viewport_width = "1430"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '6i custom_viewport_height = "820"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '7i custom_viewport_x = "250"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '8i custom_viewport_y = "135"' /opt/ares/configs/pspminis/retroarch.cfg
  else
    cp /opt/ares/configs/pspminis/retroarch.cfg /opt/ares/configs/pspminis/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sony-PSP.cfg"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/pspminis/retroarch.cfg
...
pspminis_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '5i custom_viewport_width = "950"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '6i custom_viewport_height = "540"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '7i custom_viewport_x = "165"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '8i custom_viewport_y = "90"' /opt/ares/configs/pspminis/retroarch.cfg
  else
    cp /opt/ares/configs/pspminis/retroarch.cfg /opt/ares/configs/pspminis/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sony-PSP.cfg"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/pspminis/retroarch.cfg
...
pspminis_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '5i custom_viewport_width = "1015"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '6i custom_viewport_height = "575"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '7i custom_viewport_x = "175"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '8i custom_viewport_y = "95"' /opt/ares/configs/pspminis/retroarch.cfg
  else
    cp /opt/ares/configs/pspminis/retroarch.cfg /opt/ares/configs/pspminis/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Sony-PSP.cfg"' /opt/ares/configs/pspminis/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/pspminis/retroarch.cfg
...
virtualboy_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '5i custom_viewport_width = "1115"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '6i custom_viewport_height = "695"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '7i custom_viewport_x = "405"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '8i custom_viewport_y = "215"' /opt/ares/configs/virtualboy/retroarch.cfg
  else
    cp /opt/ares/configs/virtualboy/retroarch.cfg /opt/ares/configs/virtualboy/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Virtual-Boy.cfg"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/virtualboy/retroarch.cfg
...
virtualboy_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '5i custom_viewport_width = "740"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '6i custom_viewport_height = "470"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '7i custom_viewport_x = "270"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '8i custom_viewport_y = "140"' /opt/ares/configs/virtualboy/retroarch.cfg
  else
    cp /opt/ares/configs/virtualboy/retroarch.cfg /opt/ares/configs/virtualboy/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Virtual-Boy.cfg"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/virtualboy/retroarch.cfg
...
virtualboy_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '5i custom_viewport_width = "787"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '6i custom_viewport_height = "494"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '7i custom_viewport_x = "290"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '8i custom_viewport_y = "153"' /opt/ares/configs/virtualboy/retroarch.cfg
  else
    cp /opt/ares/configs/virtualboy/retroarch.cfg /opt/ares/configs/virtualboy/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Nintendo-Virtual-Boy.cfg"' /opt/ares/configs/virtualboy/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/virtualboy/retroarch.cfg
...
wonderswan_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '5i custom_viewport_width = "950"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '6i custom_viewport_height = "605"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '7i custom_viewport_x = "495"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '8i custom_viewport_y = "225"' /opt/ares/configs/wonderswan/retroarch.cfg
  else
    cp /opt/ares/configs/wonderswan/retroarch.cfg /opt/ares/configs/wonderswan/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Bandai-WonderSwan-Horizontal.cfg"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswan/retroarch.cfg
...
wonderswan_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '5i custom_viewport_width = "645"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '6i custom_viewport_height = "407"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '7i custom_viewport_x = "325"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '8i custom_viewport_y = "148"' /opt/ares/configs/wonderswan/retroarch.cfg
  else
    cp /opt/ares/configs/wonderswan/retroarch.cfg /opt/ares/configs/wonderswan/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Bandai-WonderSwan-Horizontal.cfg"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswan/retroarch.cfg
...
wonderswan_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '5i custom_viewport_width = "690"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '6i custom_viewport_height = "435"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '7i custom_viewport_x = "345"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '8i custom_viewport_y = "155"' /opt/ares/configs/wonderswan/retroarch.cfg
  else
    cp /opt/ares/configs/wonderswan/retroarch.cfg /opt/ares/configs/wonderswan/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Bandai-WonderSwan-Horizontal.cfg"' /opt/ares/configs/wonderswan/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswan/retroarch.cfg
...
wonderswancolor_1080)
  ...
  then
    ...
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '5i custom_viewport_width = "950"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '6i custom_viewport_height = "605"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '7i custom_viewport_x = "490"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '8i custom_viewport_y = "225"' /opt/ares/configs/wonderswancolor/retroarch.cfg
  else
    cp /opt/ares/configs/wonderswancolor/retroarch.cfg /opt/ares/configs/wonderswancolor/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Bandai-WonderSwan-Color-Horizontal.cfg"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswancolor/retroarch.cfg
...
wonderswancolor_720)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '5i custom_viewport_width = "643"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '6i custom_viewport_height = "405"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '7i custom_viewport_x = "325"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '8i custom_viewport_y = "150"' /opt/ares/configs/wonderswancolor/retroarch.cfg
  else
    cp /opt/ares/configs/wonderswancolor/retroarch.cfg /opt/ares/configs/wonderswancolor/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Bandai-WonderSwan-Color-Horizontal.cfg"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswancolor/retroarch.cfg
...
wonderswancolor_other)
  ...
  then
    ...
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '4i aspect_ratio_index = "22"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '5i custom_viewport_width = "690"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '6i custom_viewport_height = "435"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '7i custom_viewport_x = "345"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '8i custom_viewport_y = "155"' /opt/ares/configs/wonderswancolor/retroarch.cfg
  else
    cp /opt/ares/configs/wonderswancolor/retroarch.cfg /opt/ares/configs/wonderswancolor/retroarch.cfg.bkp
    sed -i '2i input_overlay = "/opt/ares/configs/all/retroarch/overlay/Bandai-WonderSwan-Color-Horizontal.cfg"' /opt/ares/configs/wonderswancolor/retroarch.cfg
    sed -i '3i input_overlay_opacity = "1.000000"' /opt/ares/configs/wonderswancolor/retroarch.cfg
