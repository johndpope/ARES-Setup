...
alias autostart='sudo nano /opt/ares/configs/all/autostart.sh'
alias configs='cd /opt/ares/configs'
alias fixmali='cd mali && sudo ./install.sh && cd ~'
alias fstab='sudo nano /etc/fstab'
alias gitreset='cd ARES-Setup && git reset --hard && git clean -f -d && cd ~'
...
alias setup='sudo ~/ARES-Setup/ares_setup.sh'
