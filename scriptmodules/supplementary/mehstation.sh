...
function _add_system_mehstation() {
    ...
    NAME="$fullname" COMMAND="$command" DIR="$path" EXTS="$extensions" "/opt/ares/supplementary/mehstation/bin/mehtadata" -db="$db" -new-platform
}
...
function _del_system_mehstation() {
    ...
    PLATFORM_NAME="$fullname" "/opt/ares/supplementary/mehstation/bin/mehtadata" -db="$db" -del-platform
}
...
function _add_rom_mehstation() {
    ...
    NAME="$4" FILEPATH="$path" PLATFORM_NAME="$system_fullname" DESCRIPTION="$desc" "/opt/ares/supplementary/mehstation/bin/mehtadata" -db="$db" -new-exec

    RESOURCE="$image" FILEPATH="$path" PLATFORM_NAME="$system_fullname" TYPE="cover" "/opt/ares/supplementary/mehstation/bin/mehtadata" -db="$db" -new-res
}
