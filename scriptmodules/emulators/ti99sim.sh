...
function sources_ti99sim() {
    downloadAndExtract "http://www.mrousseau.org/programs/ti99sim/archives/ti99sim-0.15.0.src.tar.xz" "$md_build"  --strip-components 1
}
...
function configure_ti99sim() {
	...
	addEmulator 1 "$md_id-carts" "ti99" "pushd $md_inst; $md_inst/ti99sim-sdl --no-cf7 -f %ROM%; popd"
    addEmulator 0 "$md_id-xbasic+disk" "ti99" "pushd $md_inst; $md_inst/ti99sim-sdl --no-cf7 -f --dsk1=%ROM% "$romdir/ti99/xb.ctg"; popd"
    addEmulator 0 "$md_id-xbasic+cf7" "ti99" "pushd $md_inst; $md_inst/ti99sim-sdl -f --cf7=%ROM% "$romdir/ti99/xb.ctg"; popd"
    ...
    addEmulator 0 "$md_id-xbasic+cf7" "ti99" "pushd $md_inst; $sudo xinit md_inst/ti99sim-sdl -f=2 --cf7=%ROM% "$romdir/ti99/xb.ctg"; popd"
    addEmulator 0 "$md_id-ea+disk" "ti99" "pushd $md_inst; $sudo xinit md_inst/ti99sim-sdl --no-cf7 -f=2 --dsk1=%ROM% "$romdir/ti99/ea.ctg"; popd"
